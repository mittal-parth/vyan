...
export const STATIONS: Station[] = [
  ...
  {
    id: "G",
    name: "Jayanagar Shopping Complex EV Station",
    location: "Jayanagar",
    address: "Jayanagar Shopping Complex, 4th Block, 11th Main, Bangalore 560011",
    coordinates: [77.5843, 12.9254],
    distance: "3.5 km",
    rating: 4.0,
    image: "/battery-1.png",
    charged: 4,
    ...
    status: "at-risk",
    percentage: 20,
    predictedEmptyIn: "1.8 hours",
    forecast: [6, 4, 2, 1, 0, 2, 4],
    swapFee: 5,
  ...
  {
    id: "H",
    name: "Marathahalli Bridge Express",
    location: "Marathahalli",
    address: "Below Marathahalli Bridge, Outer Ring Road, Near Shell Petrol Pump, Bangalore 560037",
    coordinates: [77.7015, 12.9567],
    distance: "12.8 km",
    rating: 4.3,
    image: "/battery-1.png",
    charged: 16,
